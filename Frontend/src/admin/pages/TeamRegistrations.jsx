...
const TeamRegistrations = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      // Client-side export - WITHOUT IDs and WITH mobile number
      const exportData = filteredRegistrations.map((reg) => {
        ...
        return {
          Category: event?.eventType || "N/A",
          "Event Name": event?.title || "N/A",
          "Team Name": team?.teamName || "N/A",
          "Team Leader": leader?.name || "N/A",
          Teammates: members?.map((m) => m?.name).join(", ") || "",
          Phone: leader?.mobile_no || "N/A",
          Gender: leader?.gender || "N/A",
          Email: leader?.email || "N/A",
          "College name": leader?.college || "N/A",
          City: leader?.city || "N/A",
          Course: leader?.course || "N/A",
        };
      });
      ...
      XLSX.writeFile(
        wb,
        `team-registrations-${new Date().toISOString().split("T")[0]}.xlsx`,
      );
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-purple-50 p-6">
                ...
                {filteredRegistrations.map((reg) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${paymentBadge.color}`}
                        >
...
// Registration Details Modal - WITHOUT IDs
          ...
          <div className="mb-8">
            ...
            <div className="bg-purple-50 p-4 rounded-xl border border-purple-200">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <InfoItem label="Team Name" value={team?.teamName} />
                <InfoItem
                  label="Created At"
          ...
          <div className="mb-8">
            ...
            <div className="bg-green-50 p-4 rounded-xl border border-green-200">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <InfoItem label="City" value={leader?.city} />
                <InfoItem label="Gender" value={leader?.gender} />
              </div>
            </div>
          </div>
